...
<head id="Head2" runat="server">
    <title>- Excellerator :: Health Insurance</title>
            ...
            <ContentTemplate>
                ...
                <div class="Container">
                    ...
                    <div id="Panel1" style="display: none;" class="DivForgotPasswordPanel">
                        <iframe id="frameeditexpanse" frameborder="0" src="Forgotpassword.aspx" height="300" width="350"
                            scrolling="no"></iframe>
                    </div>
                    ...
                    <div class="loginfooterouter">
                        <footer>
                            <p>&copy; <%: DateTime.Now.Year %> - Excellerator :: Health Insurance. All Rights Reserved.
